...
/***/ "./src/js/modules/application/viewApplication.ts":
/*!*******************************************************!*\
  !*** ./src/js/modules/application/viewApplication.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ViewApplication": () => (/* binding */ ViewApplication)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _domain_service_viewRepository__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../domain/service/viewRepository */ "./src/js/modules/domain/service/viewRepository.ts");
/* harmony import */ var _domain_model_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../domain/model/view */ "./src/js/modules/domain/model/view.ts");
...
var ViewApplication = /** @class */ (function () {
    function ViewApplication(fadeTime) {
        if (fadeTime === void 0) { fadeTime = null; }
        this.fadeTime = fadeTime === null ? 1000 : fadeTime;
        this.viewRepository = new _domain_service_viewRepository__WEBPACK_IMPORTED_MODULE_1__.ViewRepository();
        this.parentDomId = 'alertContent';
        this.parentDom = document.getElementById(this.parentDomId);
    }
    ViewApplication.prototype.createVariableInput = function (variable) {
        var _this = this;
        var view = new _domain_model_view__WEBPACK_IMPORTED_MODULE_2__.View();
        this.cretateAlert(view.cretateInputVariable());
        document.getElementById('variableCancel').addEventListener('click', function () { _this.hideAlert(); });
        document.getElementById('variableConfirm').addEventListener('click', function () {
            var nameEle = document.getElementById('inputVariableName');
            var valEle = document.getElementById('inputVariableValue');
     ...
     * @param dom 表示させるDOM
     */
    ViewApplication.prototype.cretateAlert = function (dom) {
        this.parentDom.appendChild(dom);
    };
    /**
     * アラート内容のDOMを削除する
     */
    ViewApplication.prototype.breakAlert = function () {
        this.parentDom.innerHTML = '';
    };
    ViewApplication.prototype.showAlert = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#".concat(this.parentDomId)).fadeIn(this.fadeTime);
                        return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, _this.fadeTime); })];
                    case 1:
                        _a.sent();
    ...
    ViewApplication.prototype.hideAlert = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#".concat(this.parentDomId)).fadeOut(this.fadeTime);
                        return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, _this.fadeTime); })];
                    case 1:
                        _a.sent();
                        this.breakAlert();
...
/***/ "./src/js/modules/domain/model/view.ts":
/*!*********************************************!*\
  !*** ./src/js/modules/domain/model/view.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var View = /** @class */ (function () {
    ...
    View.prototype.createInput = function (placeholder, type, classList, id) {
        var _a;
        var inputDom = document.createElement('input');
        inputDom.setAttribute('type', type);
        inputDom.setAttribute('placeholder', placeholder);
        (_a = inputDom.classList).add.apply(_a, classList);
     ...
     * @memberof View
     */
    View.prototype.cretateInputVariable = function () {
        /* 全ての親 */
        var inputVariableDom = document.createElement('div');
        inputVariableDom.classList.add('input-variable-box');
        /* 変数の名前、変数の値を入力するためのDIV親 */
        var inputBoxDom = document.createElement('div');
        inputBoxDom.classList.add('input-variable-button-box');
        var inputVariableNameDivDom = document.createElement('div');
        inputVariableNameDivDom.classList.add('input-variable-name-box');
        var inputVariableValueDivDom = document.createElement('div');
        inputVariableValueDivDom.classList.add('input-variable-value-box');
        var inputVariableNameDom = this.createInput('変数名', 'text', ['input-variable-name', 'input-variable-form'], 'inputVariableName'); // 変数名を入力するinput要素
        var inputVariableValueDom = this.createInput('値', 'text', ['input-variable-value', 'input-variable-form'], 'inputVariableValue'); // 変数の値を入力するinput要素
        ...
        var inputVariableButtonDom = document.createElement('div');
        inputVariableButtonDom.classList.add('input-variable-button');
        /* 確定ボタンdiv */
        var inputVariableButtonConfirmDom = document.createElement('div');
        inputVariableButtonConfirmDom.classList.add('input-variable-button-confirm');
        /* 確定ボタンのテキスト */
        var inputVariableButtonConfirmTextDom = document.createElement('span');
        ...
        /* キャンセルボタンdiv */
        var inputVariableButtonCancelDom = document.createElement('div');
        inputVariableButtonCancelDom.classList.add('input-variable-button-cancel');
        /* キャンセルボタンのテキスト */
        var inputVariableButtonCancelTextDom = document.createElement('span');
...
/***/ "./src/js/modules/domain/service/viewRepository.ts":
/*!*********************************************************!*\
  !*** ./src/js/modules/domain/service/viewRepository.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var ViewRepository = /** @class */ (function () {
    function ViewRepository() {
        this.isAlertShow = document.getElementById('alertContent').style.display !== 'none';
    }
    ViewRepository.prototype.setIsAlertShow = function (isAlertShow) {
        this.isAlertShow = isAlertShow;
    };
    ViewRepository.prototype.getIsAlertShow = function () {
...
/* harmony import */ var _modules_application_viewApplication__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/application/viewApplication */ "./src/js/modules/application/viewApplication.ts");
...
function variableAdd() {
    var view = new _modules_application_viewApplication__WEBPACK_IMPORTED_MODULE_3__.ViewApplication();
...
document.getElementById('variableAdd').addEventListener('click', function (e) {
    e.preventDefault();
    variableAdd();
});
